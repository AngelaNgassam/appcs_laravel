    ...
    <div class="planche-container">
        <div class="planche-header">
            ...
            <div class="planche-info">
                ...
                Modèle: <?php echo e($modele?->nom_modele ?? 'Cameroun (Par défaut)'); ?>

            </div>
        </div>
        
        <div class="cartes-grid">
            <?php $__currentLoopData = $cartes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card cameroun">
                        ...
                        <div class="card-body">
                            ...
                            <div class="photo-section">
                                <div class="photo-frame">
                                    <?php if($carte['photoBase64']): ?>
                                        <img src="<?php echo e($carte['photoBase64']); ?>" alt="Photo">
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="info-section">
                                <div class="card-title"><?php echo e($carte['etablissement']->nom); ?></div>
                                
                                <div class="info-row">
                                    <div class="info-label">Matricule :</div>
                                    <div class="info-value">
                                        <span class="matricule-box"><?php echo e($carte['eleve']->matricule); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <span class="classe-badge"><?php echo e($carte['classe']->nom); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer">
                            <div class="footer-item">Délivré: <?php echo e(now()->format('d/m/Y')); ?></div>
                            <div class="footer-center">CARTE OFFICIELLE</div>
                            <div class="footer-item footer-right">Expire: <?php echo e(now()->addYears(2)->format('d/m/Y')); ?></div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\DELL7420\Documents\Cours_CDWFS\Conception_developpement_APIREST\apppcs_projectfin\apppcs_project\apppcs_backend\resources\views/cartes/planche-impression.blade.php ENDPATH**/ ?>