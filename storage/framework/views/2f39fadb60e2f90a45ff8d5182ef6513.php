...
<head>
    ...
    <title>Prévisualisation - <?php echo e($eleve->matricule); ?></title>
    <style>
        @page {
            margin: 0;
            padding: 0;
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="info-section">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value"><?php echo e($eleve->lieu_naissance ?? 'N/A'); ?></div>
                    </div>
            ...
            <div class="footer">
                <div class="footer-top">
                    ...
                    <div>Expire: <?php echo e(now()->addYears(2)->format('d/m/Y')); ?></div>
                </div>
                <?php if($etablissement->email): ?>
                <div class="footer-email">📧 <?php echo e($etablissement->email); ?></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\LICENCE\projets\apppcs_project\apppcs_project\apppcs_backend\resources\views/cartes/preview.blade.php ENDPATH**/ ?>